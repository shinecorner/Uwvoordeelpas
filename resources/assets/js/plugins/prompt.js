		...
		*/
		open: function(message, options) {
			...
			msgbox += '<div class="'+ opts.prefix +' '+ opts.classes.prompt +'">'+
						'<form action="#" class="ui tiny form '+ opts.prefix +'form '+ opts.classes.form +'">'+
		...
		*/
		addState: function(statename, stateobj, afterState) {
			...
			if(stateobj.title && stateobj.title !== ''){
				title = '<div class="lead '+ opts.prefix + 'title '+ opts.classes.title +'">'+ stateobj.title +'</div><div class="ui mini error errors message '+ stateobj.uid +'"></div><div class="ui success message '+ stateobj.uid +'"></div>';
			}
			...
			for(i=0, l=buttons.length; i<l; i++){
				...
				state += '<button type="submit" class="'+ stateobj.uid +''+ opts.classes.button +' '+ opts.prefix + 'button '+ defbtn;
