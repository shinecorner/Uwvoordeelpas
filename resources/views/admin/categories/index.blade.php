...
<div class="content">
    ...
    <div class="buttonToolbar">  
         <div class="ui grid">
            <div class="left floated sixteen wide mobile eleven wide computer column">
                ...
                <a href="{{ url('admin/categories/merge') }}" class="ui icon button"><i class="random icon"></i> Samenvoegen </a>
            </div>
    ...
    <div class="ui info message">Categorie&euml;n met 0 affiliaties zijn niet zichtbaar op de website.</div>
