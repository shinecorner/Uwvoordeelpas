...
<div class="content">
    ...
    <div class="buttonToolbar">  
        <div class="ui grid">
            <div class="left floated sixteen wide mobile nine wide computer column">
                <a href="{{ url('admin/faq/categories/create/parent') }}" class="ui icon blue button"><i class="plus icon"></i> Nieuw</a>
                ...
                <a href="{{ url('admin/faq/categories/children') }}" class="ui icon button">
                    <i class="plus icon"></i> Subcategorie&euml;n
                </a>
            </div>
    ...
    <?php echo Form::open(array('id' => 'formList', 'url' => 'admin/faq/categories/delete', 'method' => 'post')) ?>
        <table class="ui sortable very basic collapsing celled table list" style="width: 100%;">
            <thead>
            	<tr>
                    ...
                    <th data-slug="name" class="six wide">Naam</th>
                    <th data-slug="disabled"></th>
            	</tr>
            </thead>
            <tbody class="list search">
                @if(count($data) >= 1)
                	@include('admin/faq_categories.list')
                @else
                    <tr>
