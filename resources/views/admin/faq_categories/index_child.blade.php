    ...
    <div class="buttonToolbar">  
        <div class="ui grid">
            <div class="left floated sixteen wide mobile nine wide computer column">
                <a href="{{ url('admin/faq/categories/create/child') }}" class="ui icon blue button">
                ...
                <a href="{{ url('admin/faq/categories') }}" class="ui icon button">
                    <i class="plus icon"></i> Categorie&euml;n
                </a>
            </div>
        ...
        <table class="ui sortable very basic collapsing celled table list" style="width: 100%;">
            <thead>
            	<tr>
                    ...
                    <th data-slug="categoryName" class="six wide">Subcategorie van</th>
                    <th data-slug="disabled"></th>
            	</tr>
            </thead>
            <tbody class="list search">
                @if(count($data) >= 1)
                    @include('admin/faq_categories.list_child')                
                @else
                    <tr>
