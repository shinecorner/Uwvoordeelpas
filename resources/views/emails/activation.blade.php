...
Vanaf nu kunt u profiteren van de voordelen van een Uwvoordeelpas-account.  
Klik op de onderstaande link om uw account te activeren:<br /><br />

<a href="<?php echo URL::to('activate/'.$code); ?>"><?php echo URL::to('activate/'.$code); ?></a><br /><br />
