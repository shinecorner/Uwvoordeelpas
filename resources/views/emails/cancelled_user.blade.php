...
<p>Onlangs heeft u bij het bedrijf<strong><?php echo $data->companyName; ?></strong> uw reservering van <?php echo $reservationDate->formatLocalized('%d %B %Y'); ?>  om {{ date('H:i', strtotime($data->time)) }} geannuleerd.</p>
