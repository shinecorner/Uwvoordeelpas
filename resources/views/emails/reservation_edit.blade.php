...
<p>Onlangs heeft het bedrijf <strong><?php echo $data->companyName; ?></strong> uw reservering van <?php echo $reservationDate->formatLocalized('%d %B %Y'); ?>  om {{ date('H:i', strtotime($data->time)) }} gewijzigd.</p>
<p>Klik <a href="<?php echo URL::to('account/reservation/edit/'.$data->id); ?>">hier</a> om uw reservering te wijzigen</p>
