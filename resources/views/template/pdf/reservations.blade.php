...
<body>
    <table style="width: 100%;">
        <tbody>
            <tr>
                <td style="width: 500px;"><img src="{{ url('public/images/logo.png') }}" width="150" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width: 100%" class="header">
        <tr>
            <td style="width: 50%; vertical-align: middle;">
                <h1 style="text-align: left">Reserveringen</h1>
            </td>
        </tr>   
    </table>
    ...
    <table class="detail" style="margin: 0px; border-top: none;">
        <tr>
            ...
            <td class="field">{{ date('d-m-Y', strtotime($date)) }}</td>
        </tr>
    </table>
    
    <table class="list" style="width: 99%; margin-top: 1em;">
        <tr class="head">
            <td class="center" style="width: 5%">Tijd</td>
            <td class="center" style="width: 5%">Personen</td>
            <td style="width: 15%">Naam</td>
            <td style="width: 15%">E-mail</td>
            <td style="width: 15%">Telefoon</td>
            <td style="width: 15%">Allergie&euml;n</td>
            <td style="width: 15%">Voorkeuren</td>
            <td style="width: 15%">Saldo</td>
        </tr>
		  
        @if(isset($reservations))
            @foreach($reservations as $reservationId => $reservationGroup)
                @if(isset($reservations[$reservationId]['reservations']))
                    @foreach($reservations[$reservationId]['reservations'] as $reservationId => $reservation)
                    <tr class="list_row">
                        <td class="center">{{ date('H:i', strtotime($reservation['time'])) }}</td>
                        ...
                        <td>
                            @if (
                                ...
                                @foreach(json_decode($reservation['allergies']) as $allergies)
                                    {{ $allergies }}<br />
                                @endforeach
                            @endif
                        </td>
                        <td>
                            @if (
                                ...
                                @foreach(json_decode($reservation['preferences']) as $preference)
                                    {{ $preference }}<br />
                                @endforeach
                            @endif
                        </td>
                        <td>&euro;{{ $reservation['saldo'] }}</td>
                    </tr>
                    @endforeach
                @endif
            @endforeach
